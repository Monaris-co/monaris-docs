...
description: "A 0–1000 reputation score powered by the Monaris Credit Algorithm (MCA) — blending on-chain cashflow with off-chain financial data"
---

The Monaris Score is a 0–1000 reputation score powered by the **Monaris Credit Algorithm (MCA)**. It is the central product of the entire Monaris platform. Every product feeds it. Everything valuable in Monaris is unlocked by it. It is the equivalent of a credit score — but real-time, global, privacy-preserving, and built on data that actually reflects your financial reality.
